...
public class TicketConstants {
    ...
    public static final String TICKET_PRICE_MIN = "Price must be greater than 0";
    public static final String TICKET_PRICE_MAX ="Price must be less than or equal to 9999.99";
    public static final String TICKET_NAME_ALREADY_EXISTS = "TicketName already exists!";
